const server_url = 'https://api.annotator-capstone.ml:443'
...
$(document).on('click', '.lrn-dropdown', function (e) {
  ...
  $('#loadHist').click(function() {
      var data = document.getElementById("histEditor").value;
      $.ajax({
          url: server_url+'/loadhistory',
          type: 'POST',
  ...
  $('#uploadHist').click(function() {
      var data = document.getElementById("histEditor").value;
      $.ajax({
          url: server_url+'/uploadhistory',
          type: 'POST',
          contentType: 'application/json',
          data: data,
          success: function(response){
          ...
          if($('#optionGer').is(':checked')){
              ...
              $.ajax({
                  ...
                  success: function(response){
                      ...
                      myAlert('German word embedding is not implemented yet. Instead the english embedding was loaded.');
                      console.log(response);
                  },
                  error: function(error){
                      console.log(error);
